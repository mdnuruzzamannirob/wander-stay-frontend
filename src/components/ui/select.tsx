...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        'border-input bg-background flex h-9 w-full items-center justify-between rounded-md border px-3 py-2 text-sm shadow-xs transition outline-none',
...
function SelectContent({
  ...
  position = 'popper',
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Content> & { position?: 'popper' }) {
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'z-50 min-w-[8rem] overflow-hidden rounded-md border shadow-md',
          position === 'popper' &&
