...
const AMENITY_ICON: Record<string, React.ReactNode> = {
  'Free Wi-Fi': <Wifi className="size-4" />,
  ...
  'Beach Access': <Waves className="size-4" />,
  'Kids Club': <BabyIcon className="size-4" />,
  Casino: <SpadeIcon className="size-4" />,
  'Bar/Lounge': <Coffee className="size-4" />,
  'Airport Shuttle': <Car className="size-4" />,
  'Ski Access': <Landmark className="size-4" />,
  'Pet Friendly': <PawPrint className="size-4" />,
};
  ...
  return (
    <>
      ...
      <div className="app-container py-8 md:py-10">
          ...
          <div className="space-y-10 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {hotel.tag && (
                  <span className="rounded-full bg-slate-900 px-3 py-1 text-[10px] font-semibold tracking-wider text-white uppercase">
                    {hotel.tag}
                  </span>
                )}
              </div>
            ...
            <div>
              ...
              <div className="text-muted-foreground space-y-3 text-[15px] leading-relaxed">
                <p>
                  Welcome to <span className="font-semibold text-slate-800">{hotel.name}</span>, a
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-4">
                {hotel.amenities.map((amenity) => (
                  <div
                    key={amenity}
                    className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/60 px-4 py-3 text-sm font-medium transition-colors hover:border-gray-200 hover:bg-gray-50"
                  >
                    <span className="text-primary shrink-0">
                      {AMENITY_ICON[amenity] ?? <Globe className="size-4" />}
                    </span>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-3">
                <div className="flex items-center gap-1 rounded-lg bg-amber-400 px-2.5 py-1 text-sm font-bold text-white">
                  <Star className="size-3.5 fill-current" /> {avgRating}
                </div>
        ...
        {/* ---- CTA Banner ---- */}
        <section className="mt-14 mb-4 overflow-hidden rounded-2xl bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-center text-white md:p-12">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            ...
            <Link href="/hotels">
              <Button
                variant="outline"
                size="lg"
                className="border-white/20 text-base font-semibold text-white hover:bg-white/10"
              >
                Browse More Hotels
              </Button>
            </Link>
